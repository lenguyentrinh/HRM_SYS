-- =============================================================================
-- INITIAL SCHEMA – HRM Management App (Custom Auth – không dùng Supabase Auth)
-- Chạy toàn bộ file này trong Supabase SQL Editor
--
-- Reset nếu cần chạy lại từ đầu:
...
-- =============================================================================
-- TABLE: users  (custom auth – không liên kết auth.users)
-- =============================================================================
...
-- =============================================================================
-- TABLE: shift_schedules (ngày cụ thể, ưu tiên hơn assignment)
-- =============================================================================
...
-- =============================================================================
-- RLS – mở hoàn toàn cho anon key (app nội bộ, auth tự quản lý ở tầng app)
-- =============================================================================
...
-- Cho phép anon key đọc/ghi tất cả (authorization được xử lý ở tầng app)
DO $$
DECLARE
  t TEXT;
BEGIN
...
-- =============================================================================
-- SEED: Tạo dữ liệu ban đầu
-- password_hash là SHA-256 của '123456'
-- Thay bằng hash thật qua app hoặc tính tại: https://emn178.github.io/online-tools/sha256.html
-- =============================================================================
...
-- Bước 3: tạo leave policies mặc định
